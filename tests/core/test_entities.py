...
def test_entity_structure_with_constructor():
    ...
    simulation = Simulation(tax_benefit_system, simulation_json)
...
def test_set_input():
    ...
    person = simulation.person
    assert_near(person('salary', "2017-12"), [2000, 0, 4000, 0, 0])
    assert_near(person('salary', "2017-10"), [2000, 3000, 4000, 0, 0])
    assert_near(person('salary', "2017-09"), [2000, 3000, 0, 0, 0])


def test_set_input_legacy():
    ...
    simulation = new_simulation(simulation_json)
    person = simulation.person
    assert_near(person('salary', "2017-12"), [2000, 0, 4000, 0, 0])
    assert_near(person('salary', "2017-10"), [2000, 3000, 4000, 0, 0])
    assert_near(person('salary', "2017-09"), [2000, 3000, 0, 0, 0])
