...
def test_add_axis_on_persons(simulation_builder, persons):
    ...
    assert simulation_builder.get_input('salary', '2018-11')[1] == approx([0, 1500, 3000])
...
def test_add_two_axes(simulation_builder, persons):
    ...
    simulation_builder.expand_axes()
    assert simulation_builder.get_input('salary', '2018-11')[1] == approx([0, 1500, 3000])
    assert simulation_builder.get_input('pension', '2018-11')[1] == approx([0, 1000, 2000])
...
def test_add_axis_on_group_entity(simulation_builder, persons, group_entity):
    ...
    assert simulation_builder.get_input('rent', '2018-11')[1] == approx([0, 0, 3000, 3000])
...
def test_add_perpendicular_axes(simulation_builder, persons):
    ...
    simulation_builder.expand_axes()
    assert simulation_builder.get_input('salary', '2018-11')[1] == approx([0, 1500, 3000, 0, 1500, 3000])
    assert simulation_builder.get_input('pension', '2018-11')[1] == approx([0, 0, 0, 2000, 2000, 2000])
