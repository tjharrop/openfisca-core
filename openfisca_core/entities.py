    ...
    def check_variable_defined_for_entity(self, variable_name):
        ...
        if not isinstance(self, variable_entity):
            message = linesep.join([
                ...
                u"<https://doc.openfisca.org/coding-the-legislation/50_entities.html>."])
...
See more information at <https://doc.openfisca.org/coding-the-legislation/35_periods.html#periods-for-variable>.
